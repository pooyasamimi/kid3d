...
export function loadKid(gltfLoader, scene, textureLoader) {
  const fabricColorTex = textureLoader.load('https://cdn.jsdelivr.net/gh/pooyasamimi/kid3d@glb-branch/textures/fabric/Color.jpg')
  const fabricRoughnessTex = textureLoader.load('https://cdn.jsdelivr.net/gh/pooyasamimi/kid3d@glb-branch/textures/fabric/Roughness.jpg')
  const fabricNormalMapTex = textureLoader.load('https://cdn.jsdelivr.net/gh/pooyasamimi/kid3d@glb-branch/textures/fabric/NormalGL.jpg')
